...
namespace nanoframework_nordicspp1
{
            ...
            if (args.Length != 0)
            {
                ...
                switch (args[0].ToLower())
                {
                    ...
                    case "wifi":
                        ...
                        bool isConnected = WifiNetworkHelper.ConnectDhcp(args[1], args[2], WifiReconnectionKind.Automatic, requiresDateTime: true, token: cancelToken.Token);
                        PrintMemory("wifi " + isConnected);
                        if (isConnected)
